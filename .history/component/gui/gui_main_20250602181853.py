...
from PyQt5.QtCore import Qt, QSize, QTimer, QAbstractListModel, QModelIndex, QVariant, pyqtSignal, QMetaObject
...
class DuplicateFinderGUI(QWidget):
    ...
    def find_duplicates(self):
        ...
        def worker():
            ...
            QMetaObject.invokeMethod(self, "_invoke_update_ui", QtCore.Qt.QueuedConnection)
            print("[DEBUG] find_duplicates.worker: QTimer.singleShot after update_ui")
    ...
    def _invoke_update_ui(self):
        self.update_ui(self._pending_duplicates, self._pending_folder)
